...
public class TutorialDialogHelper extends DialogFragment implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.btn_tutorial_ok) {
			...
			} else if (mType == GameActivity.GAME_CLASSIC_REVERSE) {
				((HomeActivity) getActivity())
						.startGameActivity(GameActivity.GAME_CLASSIC_REVERSE);
			} else if (mType == GameActivity.GAME_SWAP) {
				((HomeActivity) getActivity())
						.startGameActivity(GameActivity.GAME_SWAP);
			} else if (mType == GameActivity.GAME_SWAP_REVERSE) {
				((HomeActivity) getActivity())
