...
public class ArcadeGameFragment extends BaseFragment implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!mSharedPrefs.getShowArcade()) {
			mSharedPrefs.setShowArcade(true);
	...
	private void startArcadeGame(int numBlinks, long timer) {
		...
		getBaseActivity().fragmentTransaction(R.id.arcade_container, 1,
				arcadeFragment, true, ArcadeFragment.TAG_CLASSIC_ARCADE);
